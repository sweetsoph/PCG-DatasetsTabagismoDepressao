...
def plot_depressivos(dadosd):
    base = pd.DataFrame(dadosd)

    # chama a função 'subplots' e dá o tamanho do gráfico
    fig, ax = plt.subplots(figsize=(12, 7))

    # gera as legendas para o gráfico
    ax.set_title("Percentual de Pessoas Depressivas no Brasil")
    ...
    ax.barh(bar_positions, base.Y1, height=bar_height, label="H", color='blue', align='center')
    ax.barh(bar_positions, -base.Y2, height=bar_height, label="M", color='red', align='center')
